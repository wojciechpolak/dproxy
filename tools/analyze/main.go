...
// analyzers lists the passes to run. lostcancel catches a context cancel
// function that nothing calls. nilness catches impossible nil comparisons and
// guaranteed nil dereferences. unusedwrite catches writes to struct fields that
// nothing reads.
